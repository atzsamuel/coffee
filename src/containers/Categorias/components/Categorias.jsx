...
export default class Categorias extends Component {
  constructor(props) {
    ...
    this.state = {
      lsData: [
        {
          id: '1',
          nombre: 'Platos fuerte',
          descripcion: 'Plato con carnes, bebida y postre',
          tipo: 'Sin alcohol',
        },
      ],
      dropdownOpen: false,
  ...
  addUser(e, data, type) {
    ...
    this.setState({
      ...
      tipo: type === 'm' ? data.tipo : '',
    });
  }

  render() {
    const {
      iestado, dropdownOpen, modal, nombre, descripcion, text, lsData, tipo,
    } = this.state;
        ...
        <Card>
          <CardBody>
            <div className="card__title">
              <h5 className="bold-text">Categorias</h5>
              <h5 className="subhead">Administracion de categorias</h5>
            </div>
            <Row>
              <Col lg={3} md={6} sm={6}>
            ...
            <Modal isOpen={modal} className="modal-dialog modal-dialog-centered modal-lg">
              ...
              <ModalBody>
                ...
                <Row>
                  <Col lg={6}>
                    <Input id="idestado" name="estado" placeholder="Ingrese el tipo" value={tipo} onChange={e => this.onChange2(e)} />
                  </Col>
                </Row>
              </ModalBody>
              <ModalFooter>
